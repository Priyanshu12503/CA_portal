  ...
  payButton.addEventListener("click", function () {
    ...
    fetch("http://localhost:8080/api/payment/create-order", {
      ...
      .then((data) => {
        ...
        const options = {
          key: "rzp_test_Ri4oWDBUQlFc6f",
          amount: currentPrice * 100,
          currency: "INR",
          name: "Jawala Java Technologies",
          description: "CA for saving and grwing",
          image:
            "https://www.reed.com/learning/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Ftfpjkpoqu48y%2F5X3ulE8nzl50MsEwBWaWNl%2Fcf89a7dafb73fd7646100a673ad3cb84%2FChartered_Accountant-_SMALL.jpg&w=3840&q=75", // Add your logo here
